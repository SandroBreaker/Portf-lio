document.addEventListener("DOMContentLoaded", () => {
  ...
  const projects = [
    ...
    {
      title: "E-commerce de Roupas Góticas",
      description: "Loja virtual responsiva com carrinho de compras, integração de pagamento e painel administrativo para produtos.",
      thumbnail: "assets/project2.png",
      demoLink: "https://demo.seusite.com/ecommerce",
      repoLink: "https://github.com/seunome/ecommerce-gotico"
    },
    {
      title: "Blog Pessoal com CMS",
      description: "Plataforma de blog desenvolvida com um sistema de gerenciamento de conteúdo (CMS) customizado, permitindo publicações dinâmicas.",
      thumbnail: "assets/project3.png",
      demoLink: "https://blog.seunome.com",
      repoLink: "https://github.com/seunome/blog-cms"
    },
    {
        title: "API RESTful para Eventos",
        description: "Backend robusto para gerenciar eventos, usuários e inscrições, construído com Node.js e Express.",
        thumbnail: "assets/project4.png",
        repoLink: "https://github.com/seunome/api-eventos" // Pode não ter demoLink se for só API
    }
